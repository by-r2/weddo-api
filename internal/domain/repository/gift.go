...
// GiftListParams agrupa paginação, filtros e ordenação para listagem de presentes.
...
type GiftRepository interface {
	...
	List(ctx context.Context, weddingID string, p GiftListParams) ([]entity.Gift, int, error)
